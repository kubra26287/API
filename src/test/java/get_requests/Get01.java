...
*/
    ...
    public void get01() {
        ...
        //            ii) Set the expected data --> beklenen veriyi kur //Bu adimi post ve put gibi data gonderilecek methodlarda yapacagiz

        //            iii) Send the request and get the response --> request'i gönder ve response'ı al
       Response response = given().get(url);
       response.prettyPrint();
        //            iv) Do assertion --> Doğrulama yap "then" ile yapilir
