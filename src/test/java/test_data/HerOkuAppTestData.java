...
public class HerOkuAppTestData {
    ...
    public Map<String, Object> expectedDataMethod(String firstname,String lastname,int totalprice,boolean depositpait,Map<String,String> bookingdatesMap,String additionalneeds){
